...
To use these stylesheets, rename the files and civicrm with the name of your theme.
...
civicrm-alpha-default-narrow.css  
...
civicrm-alpha-default-normal.css
...
civicrm-alpha-default-wide.css
